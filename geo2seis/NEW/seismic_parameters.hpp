...
class SeismicParameters {
  public:
    ...
    void                FindMaxTwtIndex(size_t & i_max, size_t & j_max, double & max_value, bool ps_seis);
    ...
    std::vector<double> GenerateTwt0ForNMO(size_t & time_stretch_samples, bool ps_seis);
