                                              ...
                                              GenSeisTraceParams *param)
{
  ...
  while (param->seismic_traces.try_pop(trace)){
    ...
    if (GenerateTraceOk(param->seismic_parameters, i, j)) {
      ...
      param->seismic_parameters.seismicOutput()->printMatrix(twtx, "old_twtx.txt");
      param->seismic_parameters.seismicOutput()->printMatrix(twtx_reg, "old_twtx_reg.txt");
      param->seismic_parameters.seismicOutput()->printMatrix(refl_pos, "old_refl_pos.txt");
      param->seismic_parameters.seismicOutput()->printMatrix(theta_pos, "old_theta_pos.txt");
      param->seismic_parameters.seismicOutput()->printVector(vrms_vec, "old_vrms_vec.txt");
      param->seismic_parameters.seismicOutput()->printVector(vrms_vec_reg, "old_vrms_vec_reg.txt");
      param->seismic_parameters.seismicOutput()->printVector(param->twt_0, "old_twt_0.txt");
      param->seismic_parameters.seismicOutput()->printVector(twt_vec, "old_twt_vec.txt");
      param->seismic_parameters.seismicOutput()->printVectorSizeT(n_min, "old_n_min.txt");
      param->seismic_parameters.seismicOutput()->printVectorSizeT(n_max, "old_n_max.txt");
      param->seismic_parameters.seismicOutput()->printMatrix(timegrid_pos, "old_timegrid_pos.txt");
      param->seismic_parameters.seismicOutput()->printMatrix(nmo_timegrid_pos, "old_nmo_timegrid_pos.txt");
